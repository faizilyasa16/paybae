...
export default function TimeMachineModal({ isOpen, onClose, balance = 0, totalIncome = 0, totalExpense = 0 }) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/50 dark:bg-slate-950/80 backdrop-blur-md transition-colors duration-300">
